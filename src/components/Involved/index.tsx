...
const Involved = () => {
  return (
    <div className="flex flex-wrap gap-5 w-full justify-between px-5 md:px-[5rem] mt-20 pb-20">
      <div className="flex flex-col gap-y-5">
        <p className="font-bold md:text-[18px] xs:text-[14px] text-[#11142D] dark:text-[#eee]">
          Empowering
        </p>
        <h1 className="bg-gradient-to-r from-[#b53c2a] via-[#000] dark:via-[#b53c2a] to-[#b53c2a] dark:to-[#fff] inline-block text-transparent bg-clip-text font-bold text-4xl md:leading-[120%]">
          Get Involved
        </h1>
