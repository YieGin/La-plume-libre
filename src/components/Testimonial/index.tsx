      ...
      <div className="lg:rounded-[40px] rounded-3xl bg-white dark:bg-[#030712] pt-10 pb-28 lg:px-10">
        ...
        <div className="mt-10 flex flex-col md:flex-row items-center justify-center gap-2 lg:gap-5">
          {TestimonialList.map((item, index) => (
            <div
              key={index}
              className="shadow-custom dark:shadow-[#1b1b1b] relative md:mt-10 flex flex-col items-center py-10 md:w-[420px] "
            >
              ...
              <p className="mt-2 px-5 text-center text-sm font-light text-[#525456] dark:text-[#ABABAB] lg:px-10">
                {item.text}
              </p>
